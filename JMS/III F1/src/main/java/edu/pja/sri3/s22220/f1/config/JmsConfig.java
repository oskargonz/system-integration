package edu.pja.sri3.s22220.f1.config;
...
public class JmsConfig {
    public static final String TOPIC_F1 = "F1.TOPIC";
    public static final String QUEUE_DRIVER = "DRIVER.QUEUE";
    public static final String QUEUE_MECHANIC = "MECHANIC.QUEUE";
    public static final String QUEUE_ENGINEER = "ENGINEER.QUEUE";
